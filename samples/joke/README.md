...
Also, this example needs the `Joke` CRD to be installed on the cluster. As mentioned in the 
Quick Start section, this CRD should have been automatically generated at 
`target/kubernetes/jokes.samples.javaoperatorsdk.io-v1.yml` so you can apply to your cluster with:
