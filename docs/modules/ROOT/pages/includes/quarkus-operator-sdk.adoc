...
a|icon:lock[title=Fixed at build time] [[quarkus-operator-sdk_quarkus-operator-sdk-use-v1-metrics]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-use-v1-metrics[`+++quarkus.operator-sdk.use-v1-metrics+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.operator-sdk.use-v1-metrics+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether older metrics should be used instead of the new v2 ones provided by the Java Operator SDK as of version 5.3.0. Note that using the new implementation is recommended. Please refer to link:https://javaoperatorsdk.io/docs/documentation/observability/#metrics[Metrics section of the Java Operator SDK documentation] for more information.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPERATOR_SDK_USE_V1_METRICS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPERATOR_SDK_USE_V1_METRICS+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
a| [[quarkus-operator-sdk_quarkus-operator-sdk-termination-timeout]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-termination-timeout[`+++quarkus.operator-sdk.termination-timeout+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.operator-sdk.termination-timeout+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Amount of seconds the SDK waits for reconciliation threads to terminate before shutting down. Setting this value will install a shutdown hook to wait for termination (causing `io.javaoperatorsdk.operator.Operator++#++installShutdownHook(Duration)` to be called with the specified duration).


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPERATOR_SDK_TERMINATION_TIMEOUT+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPERATOR_SDK_TERMINATION_TIMEOUT+++`
endif::add-copy-button-to-env-var[]
--
...
a| [[quarkus-operator-sdk_quarkus-operator-sdk-async-start]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-async-start[`+++quarkus.operator-sdk.async-start+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.operator-sdk.async-start+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
Whether or not starting the operator should occur asynchronously. This is useful when your operator starts slowly (which can happen if you have lots of resources that need to be put in the informers' caches), resulting in HTTP probes not being exposed quickly enough to prevent Kubernetes from considering your operator unhealthy and thus attempting to restart it.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPERATOR_SDK_ASYNC_START+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPERATOR_SDK_ASYNC_START+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`
...
[.description]
--
An optional list of comma-separated label selectors that Custom Resources must match to trigger the controller. See link:https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/[Kubernetes' labels documentation] for more details on label selectors.
...
a| [[quarkus-operator-sdk_quarkus-operator-sdk-controllers-controllers-shard-selector]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-controllers-controllers-shard-selector[`+++quarkus.operator-sdk.controllers."controllers".shard-selector+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.operator-sdk.controllers."controllers".shard-selector+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
An optional shard selector used to restrict the set of Custom Resources the controller acts upon to a single shard, typically when the same workload is split across several operator instances. Just like `selector()` it is expressed as a label selector and can be made of multiple comma separated requirements that act as a logical AND operator. When both a label selector and a shard selector are set, the resulting informer only watches resources matching both.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPERATOR_SDK_CONTROLLERS__CONTROLLERS__SHARD_SELECTOR+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPERATOR_SDK_CONTROLLERS__CONTROLLERS__SHARD_SELECTOR+++`
endif::add-copy-button-to-env-var[]
--
|string
|

a| [[quarkus-operator-sdk_quarkus-operator-sdk-controllers-controllers-field-selectors]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-controllers-controllers-field-selectors[`+++quarkus.operator-sdk.controllers."controllers".field-selectors+++`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.operator-sdk.controllers."controllers".field-selectors+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
An optional list of comma-separated field selectors that Custom Resources must match to trigger the controller. See link:https://kubernetes.io/docs/concepts/overview/working-with-objects/field-selectors/[Kubernetes' field selector documentation] for more details on field selectors.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPERATOR_SDK_CONTROLLERS__CONTROLLERS__FIELD_SELECTORS+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPERATOR_SDK_CONTROLLERS__CONTROLLERS__FIELD_SELECTORS+++`
endif::add-copy-button-to-env-var[]
--
|list of string
|
...
a|icon:lock[title=Fixed at build time] [[quarkus-operator-sdk_quarkus-operator-sdk-crd-use-deprecated-v1-crd-generator]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-crd-use-deprecated-v1-crd-generator[[.line-through]#`+++quarkus.operator-sdk.crd.use-deprecated-v1-crd-generator+++`#]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.operator-sdk.crd.use-deprecated-v1-crd-generator+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
_This property is deprecated: using this method should be reserved for blocking situations, please open an issue reporting the problem you're facing with the v2 generator before reverting to use the v1 version._

Whether or not to use the v1 version of the CRD generator. Note that this should only be used if a compatibility issue is found with the v2 generator, which is the default one and the one that is actively maintained.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_OPERATOR_SDK_CRD_USE_DEPRECATED_V1_CRD_GENERATOR+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_OPERATOR_SDK_CRD_USE_DEPRECATED_V1_CRD_GENERATOR+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++false+++`

a| [[quarkus-operator-sdk_quarkus-operator-sdk-termination-timeout-seconds]] [.property-path]##link:#quarkus-operator-sdk_quarkus-operator-sdk-termination-timeout-seconds[[.line-through]#`+++quarkus.operator-sdk.termination-timeout-seconds+++`#]##
ifdef::add-copy-button-to-config-props[]
...
[.description]
--
_This property is deprecated: Use `termination-timeout()` instead._
