...
a|icon:lock[title=Fixed at build time] [[quarkus-operator-sdk_quarkus-operator-sdk-defensive-cloning]]`link:#quarkus-operator-sdk_quarkus-operator-sdk-defensive-cloning[quarkus.operator-sdk.defensive-cloning]`
