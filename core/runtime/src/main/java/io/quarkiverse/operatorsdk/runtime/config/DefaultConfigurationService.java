...
import io.quarkiverse.operatorsdk.runtime.QuarkusDependentResourceFactory;
import io.quarkiverse.operatorsdk.runtime.QuarkusWorkflowFactory;
import io.quarkus.arc.ClientProxy;

public class DefaultConfigurationService extends AbstractConfigurationService implements
    ...
    public DefaultConfigurationService(
        ...
        // initializing the executor service now requires variables to be set earlier since the configuration of threads number is required when starting the executors
        init(null, super.getExecutorServiceManager(), kubernetesClient);
